...
int main()
{
    ...
    printf("\t\t\t\t\t\tsection:k17bg>>rollno:21>>11701097\n");
    printf("\t\t====================================================================================================\n");
    ...
    for(i=0;i<n;i++)
    {
     ...
     for(i=0;i<n;i++)
    {
        printf("Process P%d: Burst time:%d Arrivaltime:%d Ppriority:%d and Process id P%d\n",i+1,p[i].burstt,p[i].arrivalt,p[i].ppriority,p[i].pid);
    }
    ...
    printf("total Average waiting time is  %f \n",avgwaiting/n);
